...
module.exports = function (grunt) {
    destDir = grunt.option('dest') || '../cermet-dist';
        ...
        return {
            options: {
                ...
                paths: _.extend({
                    ...
                    'commons/cermet/partials_compiled': 'commons/cermet/templates/.partials_compiled',
                    'commons/cermet/templates_compiled': 'commons/cermet/templates/.templates_compiled'
                }, packagePaths),
...
function getTemplatePathsConfig(type, isDebug) {
    ...
    if (type == 'partials') {
        if (isDebug) {
            fileConfig[getSrcFile('commons/cermet/templates/.auto_partials.js')] = getSrcFiles(['commons/cermet/templates/partials/**/*.html']);
        } else {
            fileConfig[getSrcFile('commons/cermet/templates/.partials_compiled.js')] = getSrcFiles(['commons/cermet/templates/partials/**/*.html']);
        }
    }

    if (type == 'templates') {
        if (isDebug) {
            fileConfig[getSrcFile('commons/cermet/templates/.auto_templates.js')] = getSrcFiles(['commons/cermet/templates/**/*.html']);
        } else {
            fileConfig[getSrcFile('commons/cermet/templates/.templates_compiled.js')] = getSrcFiles(['commons/cermet/templates/**/*.html' ]);
        }
    }
